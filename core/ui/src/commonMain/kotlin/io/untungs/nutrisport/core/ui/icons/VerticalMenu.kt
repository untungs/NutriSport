...
val Icons.VerticalMenu: ImageVector
    get() {
        if (_VerticalMenu != null) {
            return _VerticalMenu!!
        }
        _VerticalMenu = ImageVector.Builder(
            name = "VerticalMenu",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _VerticalMenu: ImageVector? = null
